...
## Further documentation on frontend and backend

For further frontend documentation please refer to the README.md file in the [EmployeeDashboard-Backend](https://github.com/claudiozera44/EmployeeDashboard-Backend)
